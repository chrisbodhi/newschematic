        ...
        if (active && payload && payload.length) {
            return (
                ...
                >
                    <p style={{ margin: 0 }}>
                        <strong>Δv:</strong>{" "}
                        {payload[0].payload.deltaV.toFixed(2)} km/s
                    </p>
                    <p style={{ margin: 0 }}>
                        <strong>Mass Ratio:</strong>{" "}
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <p style={{ margin: "4px 0" }}>
                            Mass Ratio:{" "}
                            {skyhookIntercept.massRatio.toFixed(2)}
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <p style={{ margin: "4px 0" }}>
                            Δv: {skyhookRelease.deltaV} km/s
                        </p>
                        <p style={{ margin: "4px 0" }}>Altitude: 600 km</p>
                        <p style={{ margin: "4px 0" }}>
                            Mass Ratio:{" "}
                            {skyhookRelease.massRatio.toFixed(2)}
                        </p>
                    </div>
                </div>
                ...
                >
                    <p style={{ margin: "0" }}>
                        <strong>The Skyhook Advantage:</strong> By catching
                        a spacecraft at the lower tip (5.27 km/s instead of
                        7.8 km/s), the required mass ratio drops from{" "}
                        {directToOrbit.massRatio.toFixed(2)} to{" "}
                        {skyhookIntercept.massRatio.toFixed(2)} — that's{" "}
                        <strong>
                            {(
                                (1 -
                                    skyhookIntercept.massRatio /
                                        directToOrbit.massRatio) *
                                100
                            ).toFixed(0)}
                            % less mass needed!
                        </strong>
